...
@app_commands.guilds(discord.Object(id=GUILD_ID))
@bot.tree.command(name="autobuy", description="Purchase a key with cryptocurrency - TEMPORARILY DISABLED")
async def autobuy(interaction: discord.Interaction):
    """Temporarily disabled autobuy system"""
    await interaction.response.send_message("🚧 **Autobuy system is temporarily disabled for maintenance.**\n\nPlease contact an admin to purchase keys manually.", ephemeral=True)
